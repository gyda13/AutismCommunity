            ...
            VStack (spacing: 0)
            {
                ...
                HStack (spacing: 0){ // pic
                    ...
                    ZStack{ Image(chooseRandomImage())
                        ...
                        // wirter
                    Text(comment.writer).frame(width:50,height: 2,alignment: .leading).font(.custom( "Helvetica", size: 14)).foregroundColor(.gray)
                }
                    ...
                    }.frame(width:300,height: 20,alignment:.leading).font(.custom( "Helvetica", size: 12))
...
struct CommentView_Previews:PreviewProvider {
    static var previews: some View {
        ...
        CommentView(comment: CommentTable(writer: "Sarah Mo", content: "I found your post very informative and would like to include my thoughts in your response to thediscussion. ", PostId: ""))
